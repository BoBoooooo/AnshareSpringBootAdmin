...
import com.anshare.project.core.*;
import java.io.File;
...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/AnshareAdmin";
    ...
    private static final String AUTHOR = "Anshare";//@author
    private static final String DATE = new SimpleDateFormat("yyyy/MM/dd").format(new Date());//@date

    public static void main(String[] args) {
        genCode("SIX_RewardOrPunish");
